...
import { FadeOnScroll } from "../effects/FadeOnScroll";
export const Hero = () => {
  return (
    <div className="w-fit flex flex-col  h-screen justify-center relative">
      <img src={titleImage} />
      ...
      <div className="flex flex-col  justify-start items-start  sm:flex-row  sm:justify-between lg:px-8 px-2">
        <div className="flex flex-col justify-start items-start ">
          ...
          <h3 className="title-sub">Website & Games Developer</h3>
        </div>
